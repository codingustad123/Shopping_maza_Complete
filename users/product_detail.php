  ...
  <main>
    ...
    ?>
          ...
          <div class="product-main">
            ...
            <h2 style="font-size: 30px;" class="title">Mobiles</h2>

            <div class="product-grid">
            <?php

$query="SELECT * FROM `add_product` where `category`='Mobiles & Tablets' ";
...
?>
              <div class="showcase">
                ...
                <div class="showcase-banner">
                  ...
                  <img style="height: 200px; width: 100%;" src="../admin/system_files/product_img/<?php echo $row['9'] ?>" alt="Mens Winter Leathers Jackets" width="100%" height="170px" >
