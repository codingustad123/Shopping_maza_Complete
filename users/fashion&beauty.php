  ...
  <main>
    ...
    ?>
          ...
          <div class="product-main">
            ...
            <h2 style="font-size: 30px;" class="title">Fashion & Beauty</h2>

            <div class="product-grid">
            <?php

$query="SELECT * FROM `add_product` where `category`='Fashion & Beauty' ";
...
?>
  ...
  <a <?php echo "href=detail_page.php?p_id=$row[1]"?>><img src="../admin/system_files/product_img/<?php echo $row['9'] ?>" alt="Mens Winter Leathers Jackets" width="100%" height="170px" ></a>    
