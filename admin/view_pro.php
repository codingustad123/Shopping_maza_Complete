...
<div class="container">
    <div class="card shadow my-5">
      <h4 class="card-header">View Products</h4>
      <div class="card-body">
        <form class="mb-3">
      ...
      <table style="align-items: center; justify-content: center; text-align: center;"  class="table table-searchable table-striped table-bordered table-hover table-responsive">
          <thead style="font-size: medium;">
            <tr >
                ...
                <th style="width: 15%; ">Listed in</th>
          ...
          <tbody  style="font-size: medium;">
            ...
            <tr>
                ...
                <td><img style="height: 80px; width: 100px;" src="system_files/product_img/<?php echo $row[9] ?>"></td>
               
              <td data-searchable="false">
                <div class="btn-group btn-group-sm" role="group">
             
                    <a  <?php echo "href=edit_product.php?p_id=$row[1]"?>><button type="button" class="btn btn-outline-dark"><i class="fas fa-pen"></i></button></a>&nbsp;&nbsp;&nbsp;
                    <a <?php echo "<td><a onClick=\"javascript: return confirm('Please confirm deletion');\" href= 'del_product.php?p_id=$row[1] '   "?> > <button type="button" name="del_btn" class="btn btn-outline-dark"><i class="fas fa-trash"></i></button></a>
